...
/* 类型定义 ------------------------------------------------------------------*/
/* 宏定义 --------------------------------------------------------------------*/
#define AD7190_SPIx                 SPI1
#define AD7190_SPIx_CLK_ENABLE()    __HAL_RCC_SPI1_CLK_ENABLE()
#define AD7190_GPIO_CLK_ENABLE()   {__HAL_RCC_GPIOA_CLK_ENABLE();__HAL_RCC_GPIOC_CLK_ENABLE();__HAL_RCC_GPIOB_CLK_ENABLE();} 
#define AD7190_CS_Pin              GPIO_PIN_13
#define AD7190_CS_GPIO_Port        GPIOC
#define AD7190_SCK_Pin             GPIO_PIN_5
#define AD7190_SCK_GPIO_Port       GPIOA
#define AD7190_MISO_Pin            GPIO_PIN_4
#define AD7190_MISO_GPIO_Port      GPIOB
#define AD7190_MOSI_Pin            GPIO_PIN_5
