...
#define USART6x_BAUDRATE                        115200
#define USART6_RCC_CLK_ENABLE()                 __HAL_RCC_USART6_CLK_ENABLE()
#define USART6_RCC_CLK_DISABLE()                __HAL_RCC_USART6_CLK_DISABLE()
#define USART6x_GPIO_ClK_ENABLE()               __HAL_RCC_GPIOC_CLK_ENABLE()
#define USART6x_Tx_GPIO_PIN                     GPIO_PIN_6
#define USART6x_Tx_GPIO                         GPIOC
#define USART6x_Rx_GPIO_PIN                     GPIO_PIN_7  
#define USART6x_Rx_GPIO                         GPIOC
#define USART6x_AFx                             GPIO_AF8_USART6
